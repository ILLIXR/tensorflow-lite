...
#include "delegates/gpu/common/selectors/simple_selectors.h"
...
#include "delegates/gpu/common/tasks/add.h"
#include "delegates/gpu/common/tasks/cast.h"
#include "delegates/gpu/common/tasks/concat_xy.h"
#include "delegates/gpu/common/tasks/concat_z.h"
#include "delegates/gpu/common/tasks/cumsum.h"
#include "delegates/gpu/common/tasks/depthwise_conv.h"
#include "delegates/gpu/common/tasks/gather.h"
#include "delegates/gpu/common/tasks/lstm.h"
#include "delegates/gpu/common/tasks/max_unpooling.h"
#include "delegates/gpu/common/tasks/one_hot.h"
#include "delegates/gpu/common/tasks/padding.h"
#include "delegates/gpu/common/tasks/pooling.h"
#include "delegates/gpu/common/tasks/prelu.h"
#include "delegates/gpu/common/tasks/quantize_and_dequantize.h"
#include "delegates/gpu/common/tasks/reduce.h"
#include "delegates/gpu/common/tasks/relu.h"
#include "delegates/gpu/common/tasks/resampler.h"
#include "delegates/gpu/common/tasks/reshape.h"
#include "delegates/gpu/common/tasks/reshapex4.h"
#include "delegates/gpu/common/tasks/resize.h"
#include "delegates/gpu/common/tasks/select_v2.h"
#include "delegates/gpu/common/tasks/softmax.h"
#include "delegates/gpu/common/tasks/softmax1x1.h"
#include "delegates/gpu/common/tasks/space_to_depth.h"
#include "delegates/gpu/common/tasks/split.h"
#include "delegates/gpu/common/tasks/strided_slice.h"
#include "delegates/gpu/common/tasks/tile.h"
#include "delegates/gpu/common/tasks/transpose.h"
#include "delegates/gpu/common/tasks/winograd.h"
