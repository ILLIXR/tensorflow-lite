...
#include "examples/label_image/label_image.h"
...
#include "examples/label_image/bitmap_helpers.h"
#include "examples/label_image/get_top_n.h"
#include "examples/label_image/log.h"
